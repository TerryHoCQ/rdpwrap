...
DWORD INIReadDWordHex(INI_FILE* IniFile, const char* Sect, const char* VariableName, PLATFORM_DWORD Default)
{
...
void INIReadString(INI_FILE* IniFile, char* Sect, const char* VariableName, const char* Default, char* Ret, DWORD RetSize)
{
...
void WriteToLog(LPCSTR Text)  // 改为 LPCSTR 以接收 const char*
{
